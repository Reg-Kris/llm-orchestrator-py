...
try:
    ...
    logging.warning(f"Cost tracking dependencies not available: {e}")
...
class CostTrackingManager:
    ...
    def __init__(self):
        self.cost_calculator = cost_calculator if COST_TRACKING_AVAILABLE else None
        self.budget_manager = budget_manager if COST_TRACKING_AVAILABLE else None
        self.enabled = COST_TRACKING_AVAILABLE
